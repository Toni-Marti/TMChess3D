...
class MyScene extends THREE.Scene {
  constructor (myCanvas) {
    ...
    this.model = new Rey(this.gui, "Controles de la Caja");
    this.add (this.model);
      this.model.position.set(0, 0, 6);

     this.model2 = new Alfil(this.gui, "Controles de la Caja 2");
     this.add(this.model2);
     this.model2.position.set(3, 0, 0);

    this.model3 = new Reina(this.gui, "Controles de la Caja 3");
    this.add(this.model3);
     this.model3.position.set(0, 0, 3);

    this.model4 = new Peon
    (this.gui, "Controles de la Caja 4");
